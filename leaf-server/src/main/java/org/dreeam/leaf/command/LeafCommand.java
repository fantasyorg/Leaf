...
import org.dreeam.leaf.command.subcommands.ChunksCommand;
...
public final class LeafCommand extends Command {
    ...
    private static final LeafSubcommand CHUNKS_SUBCOMMAND = new ChunksCommand();
    private static final Map<String, LeafSubcommand> SUBCOMMANDS = Util.make(() -> {
        ...
        commands.put(Set.of(ChunksCommand.LITERAL_ARGUMENT), CHUNKS_SUBCOMMAND);
